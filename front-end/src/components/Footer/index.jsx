      ...
      <div className="container d-sm-flex">
        <div className="footer-column">
          ...
          <ul className="footer-links">
            ...
            <li>
              <Link to="/how-to-shop" className="footer-link">
                How to shop on ClearMySpace?
              </Link>
            </li>
            <li>
              <Link to="/delivery-options" className="footer-link">
                Delivery options and timelines
              </Link>
            </li>
            <li>
              <Link to="/return-product" className="footer-link">
                Report a Seller?
              </Link>
            </li>
          </ul>
